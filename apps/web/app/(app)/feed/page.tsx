  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        <Link href="/post" className="text-sm text-emerald-400 hover:underline">
          Post today →
        </Link>
      </div>
      ...
      {loading ? (
        ...
        <div className="rounded-xl border border-dashed border-zinc-700 p-12 text-center space-y-4">
